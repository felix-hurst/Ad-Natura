...
% --- begin auto-added for pdfLaTeX unicode support ---
...
\begin{document}
\title{System Verification and Validation Plan for SFWRENG 4G06 - Capstone Design Project}
\author{Team #7, Wardens of the Wild\\Felix Hurst\\
...
\end{table}
\FloatBarrier % optional (keeps it from drifting past this point)

...
* Games that the user plays (by genre), how much of each genre they generally play (hours/week)
* What themes do you enjoy in games that you have played?
* Country of origin
* Age
* Gender
...
* How long did it take to clear the game (or a specific level)? _(Note: Edit later based on how many levels we actually end up implementing.)_

*Game Mechanic Learning Curves*

Group by game mechanic and ask about learning curve time with questions specific to that mechanic:

* How long did it take before you felt comfortable with that mechanic?
* Evaluate the destructible environment on learnability: Was it too unpredictable? Were you able to harness it to clear levels and solve puzzles?
* How long did it take until you felt comfortable interacting with the slime mold?
* How long did it take you to get used to the control scheme for this game?

*Puzzle Fairness*

* When solving a puzzle, did you feel like the solution was fair and logical?

\subsubsection{Entertainment Value}

* What part(s) of the game did you enjoy the most?
* What part(s) of the game did you find frustrating?
* How would you rate each mechanic in contributing to the entertainment value of the game?
** Erosion
** Breakable objects
** Debris generation / Landslides
** Water simulation
** Slime mold pathfinding
** Slime mold as a traversable object
* For each level, please leave comments on what is: A) Entertaining, and B) Tedious

\subsubsection{Game Business Requirements}

*Controls & Intuitiveness*

* Do you believe the control scheme was intuitive?

*Performance Issues*

* Did you experience any of the following performance issues? (Accompanied with report)
** Frame drops
** Input delay
** Crashes
** Screen freezes
...
* Did you feel that the visual effects, interfaces, and sound design were effective in giving cues and feedback for your performed actions, player state, as well as environmental events?

*Value Proposition*

* Did you feel like the game was worth the time you spent playing it?

\subsubsection{Story Review / Message}

* What message did you believe this game was sending?
* What led you to believe this?
* Do you agree with the message you believe the game was sending? Why or why not?
* Did you believe the game conveyed the message effectively?
* Was messaging in the game too upfront, too subtle, or somewhere in the middle?

\subsubsection{Emotions}

* What were the most common emotions you felt while playing the game?
* How did you generally feel at the beginning of the game / Level 1?
* How did you generally feel at the end of the game / final level?
* Were there any moments that evoked a strong emotion from you? If so, what moment was it, and how did you feel?
...
*SMA Learning & Understanding*

* What did you learn about slime mold through the game?
* How well does the tutorial make clear to you the core mechanics of the slime mold?
* Did you feel like the slime mold traversal felt natural and unpredictable?
* How do you feel about the balance of level design, triggerable objects, and destructible objects in terms of the interaction of the slime mold with those elements?
* Do you consider the slime mold to be an ally, enemy, or neutral party?
* What questions do you still have about slime mold?
* Overall, what do you think is the most interesting thing about slime mold?

\subsubsection{Success Criteria Importance}

The team has ranked the importance of each success criterion as follows:

* Sending a message about human's impact on the environment: 4.25 / 5
* Making an entertaining game: 4.25 / 5
* Exploring SMA, sufficiently demonstrating its complexity: 3.75 / 5
* Making a game product that meets business requirements of conventional gamers: 3 / 5
* Conveying the emotions we intend to convey: 4 / 5

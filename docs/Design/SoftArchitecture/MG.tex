...
\item[\refstepcounter{acnum} \actheacnum \label{AC7}:] Algorithm used for edge generation (sine wave-straight angled straight line blend) with height, frequency, and blend factor parameters.

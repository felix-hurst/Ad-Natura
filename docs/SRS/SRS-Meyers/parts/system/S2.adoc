...
. Debris game objects generated shall be of the specifications to that game object referenced via characteristics dictionary as to the size, shape, color, etc.

-Organic dynamic paths(Slime mold) S2-FLD-2
. Slime mold shall be attracted to sources of and will traverse to it

. Slime mold shall provide player a traversable path in each level over obstacles and/or untraversable distances(a cliff for example)

-Replayable and Reproducible Levels S2-FLD-3

. Each level shall be completable within 1 hour of time

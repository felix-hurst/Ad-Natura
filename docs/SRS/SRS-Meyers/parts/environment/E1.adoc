...
[[gl-adnatura]]Ad Natura:: Latin for "To Nature", this is the name of our project and our game.
...
[[gl-minspec]]Minimum Spec:: The lowest hardware/OS we support for stable play (see link:https://github.com/felix-hurst/Ad-Natura/blob/main/docs/ProblemStatementAndGoals/ProblemStatement.pdf[Problem Statement] for the numbers).

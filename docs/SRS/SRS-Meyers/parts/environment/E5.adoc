...
NOTE: “Publish” = the environment makes updated data available to the system. Exact system responses live in S.* and will be verified in <<s6>>.
...
(See <<e6>> for invariants like “no NaN/Inf” and “a cell cannot be both passable and blocked in the same frame”.)

...
Colour space:: Displays run in SDR/sRGB. HDR or wide-gamut displays are treated as SDR.
...
Player:: The human player does not require accessibility modifications (for example, for colour blindness).

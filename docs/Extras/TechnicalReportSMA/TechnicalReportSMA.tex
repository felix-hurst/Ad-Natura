...
sequential stages: diffusion, entropic decay, cytoplasmic pulse, and metabolic
glow.
...
Two additional features are planned to deepen the simulation's conceptual
range and transform it from a reactive system into an interactive installation:
...
entropic decay, cytoplasmic pulse, behavioral drift, water consumption, and
metabolic glow, the system produces organic, unpredictable behavior from simple
local rules---while engaging in reciprocal material exchange with its
environment.
...
for self-organization, distributed agency, externalized memory, and resistance
to centralized control. The artist's role is not to dictate outcomes but to
construct conditions under which matter performs.

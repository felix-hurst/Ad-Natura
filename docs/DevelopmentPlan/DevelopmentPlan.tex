...
2026-3-17 & Marcos & Updating coding standard\\
\bottomrule
\end{tabularx}
\end{table}
...
We will use PascalCase for files, functions, classes. We will use camelCase for variables, Allman style code formatting\\
...
\textbf{Team}\\
3. Thankfully, our team had no disagreements during this deliverable and were all on the same page, 
so this will serve as a response to everyone's Q3.\\
